...
impl VerificationEngine {
    pub fn verify_network(
        ...
        let evidence_count = checks
            .iter()
            .map(|check| check.check.evidence.len())
            .sum();
